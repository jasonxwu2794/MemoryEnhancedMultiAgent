...
A team of 5 AI agents that live on your VPS, talk to you on Telegram, and **never forget anything**. One install command runs a beautiful setup wizard. Minutes later, you're chatting with Brain — your personal AI chief of staff — backed by a Builder, Investigator, Judge, and Guardian that work behind the scenes.
...
| | Feature | Details |
|---|---------|---------|
| 🧠 | **5 Specialized Agents** | Brain orchestrates, Builder codes, Investigator researches, Judge verifies, Guardian protects |
...
| ⚖️ **Judge** | Judge | Verifies claims, catches hallucinations, updates the knowledge cache |
...
```
    ...
    ▼     ▼     ▼       ▼
  🔨     🔍    ⚖️      🛡️
Builder Investigator Judge Guardian
```
...
| **Knowledge Cache** | Verified facts from Judge & Investigator | **No decay** |
